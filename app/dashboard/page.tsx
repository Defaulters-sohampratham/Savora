      ...
      <section className="glass-card relative overflow-hidden rounded-2xl p-6 sm:p-7 border border-slate-200/90 dark:border-white/[0.08] shadow-sm">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-xs sm:text-sm leading-relaxed text-slate-600 dark:text-slate-400">
          ...
          {!isAuthenticated && (
            <div className="flex flex-wrap gap-2 lg:flex-col lg:items-end">
              <span className="w-full text-[11px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 lg:text-right">
                Switch Demo Persona:
              </span>
                ...
                {demoProfiles.map((p) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      className={`rounded-xl px-3.5 py-2 text-xs font-semibold transition-all duration-150 active:scale-95 cursor-pointer ${
                        isSelected
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          ...
          >
            <div className="grid h-full w-full place-items-center rounded-full bg-white dark:bg-slate-900 text-center shadow-inner">
              ...
              <span className="-mt-1.5 text-[10px] font-mono font-bold text-emerald-800 dark:text-emerald-300">{confidencePercent}%</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-2xl border border-emerald-500/30 bg-emerald-500/5 dark:bg-emerald-950/20 p-6 sm:p-7 shadow-sm">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-1.5">
            ...
            <p className="max-w-2xl text-xs sm:text-sm leading-relaxed text-slate-700 dark:text-slate-300">
              {explanation}
            </p>
          </div>
          ...
          <Link
            href="/outputs"
            className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-emerald-600 px-5 py-3 text-xs font-semibold text-white shadow-xs hover:bg-emerald-700 active:scale-[0.98] dark:bg-emerald-500 dark:hover:bg-emerald-600 transition-all duration-150"
          >
      ...
      <section className="space-y-4 pt-2">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          >
            ...
            <div className="mt-4 inline-flex items-center gap-1.5 text-xs font-semibold text-emerald-700 dark:text-emerald-400">
